...
Gastrointestinal endoscopies are one of the most common medical examinations where the mucosa of the patient is visualised via a camera through the whole of the GI tract. \todo{cite:https://www.ncbi.nlm.nih.gov/pubmed/24085634}
...
%\todo{cite:https://www.who.int/medical_devices/innovation/colonoscope.pdf}
...
Dropout, first proposed by Srivastava et al.\todo{http://jmlr.org/papers/v15/srivastava14a.bib}, in 2014 was used to prevent overfitting of neural networks (As seen in figure \ref{fig:dropout}).
...
generative adversarial models can be used as a generator of new data and can have some resemblance to autoencoders \ref{Explaining_autoencoders}, especially variational autoencoders %TODO cite VAE, ref VAE
