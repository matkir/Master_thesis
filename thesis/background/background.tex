...
\todo{Here i could add general colonoscopy images to show the use of a wide angle lens, as I at this point does not talk about it}
...
\begin{figure}[h]
	...
	\label{fig:HumanGI} 
\end{figure}
%\footnote{\url{https://commons.wikimedia.org/wiki/File:Stomach_colon_rectum_diagram-en.svg}}
...
However, to truly understand how automated systems like Mirmir~\cite{Steven2018MimirPaper} \todo{is this going to become talked about at this point} works, we need to look at how Machine learning helps with the detection of the anomalies the medical staff are searching for.  
...
The agent bases its actions on the environment, and it is influenced by an objective to get the maximum reward, as illustrated in Figure \ref{fig:reinforcement_learning}.
...
\begin{figure}[h]
        \centering
        \includegraphics[width=0.34\textwidth]{background/figures/reinforcement_learning.png}
