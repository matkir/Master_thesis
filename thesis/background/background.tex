...
Pogorelov et al. also recently published a paper on the generalisation of data, for the purpose of using open datasets for training CAD systems~\cite{pogorelov2018deep}.
\todo{Porbably more}

As mentioned in the introduction, Hicks et al. published the mirmir system~\cite{25953}. \todo{more}
