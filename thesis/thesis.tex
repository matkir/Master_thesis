...
\chapter{Introduction}
	...
	* CAD ACD (computer aided diagnosis, Automated computer diagnosis)
	...
	\section{Goal / Problem}
		...
		\subsection{Use Unsupervised learning as a pre-processing tool}
		\subsection{use Unsupervised-NN/GAN for image enhancements so that a NN can train better}
	...
	\section{Scope and Limitations}
		\subsection{Use Unsupervised NN to find polyps}
		\subsection{Use Unsupervised NN for pre-processing}
...
\chapter{Background}
	...
	\textbf{might here talk about different tasks ML can do?}
	  ...
	  \begin{itemize}
	    \item subsfication
	    \item r to the pillcam projec REMegression 
