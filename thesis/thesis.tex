...
\declaretheorem[style=mystyle, name=Research Question, preheadhook={\renewcommand{\theque}{Q\textsubscript{\arabic{que}}}}]{que}

\usepackage{cleveref}
\crefname{hyp}{hypothesis}{hypotheses}
\Crefname{hyp}{Hypothesis}{Hypotheses}

\crefname{que}{question}{question}
\Crefname{que}{Question}{Question}
...
\title{Unsupervised Preprocessing of Medical Imaging Data with Generative Adversarial Networks}
%\subtitle{Using Unsupervised Learning to Increase the Accuracy of Neural Networks}
...
\section{Paper I - Using preprocessing as a tool in medical image detection} \label{AP:a}
\includepdf[pages={1-3}]{appendix/PaperMediaEval.pdf}
\section{Paper II - Unsupervised preprocessing to improve generalisation for medical data} \label{AP:b}
