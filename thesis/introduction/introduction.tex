...
Maybe, but probably not. From our tests we see no noticeable difference when we train and test on the same dataset. We do see improvement for both models when testing on a new dataset, \todo{finish this }
